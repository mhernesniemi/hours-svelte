...
{:else if user}
		<div class="mx-auto max-w-5xl p-4">
			...
			{#if error}
				<div
					class="bg-destructive/10 text-destructive mb-4 flex items-center gap-2 rounded-md p-3 text-sm"
				>
					...
					<CardContent class="py-4">
						<div class="flex items-center justify-between">
							<div class="flex items-center gap-2">
								...
								<span class="text-muted-foreground text-sm">Total this month:</span>
							</div>
				...
				{#if data.days.length === 0}
					<Card>
						<CardContent class="flex flex-col items-center justify-center py-12">
							...
							<p class="text-muted-foreground mb-4">No entries for this month</p>
							<Button onclick={() => goto('/entry/new')}>
								<Plus class="mr-2 h-4 w-4" />
							...
							<Card>
								<CardHeader class="pb-2">
									<div class="flex items-center justify-between">
										...
										<div class="flex items-center gap-3">
											<span class="text-muted-foreground text-sm">{day.totalFormatted}</span>
												...
												<div class="flex-1">
													<div class="flex items-center gap-2">
														...
														{#if entry.status === 'draft'}
															<span
																class="bg-secondary text-secondary-foreground rounded-full px-2 py-0.5 text-xs"
															>
																Draft
															</span>
														{/if}
			...
			{:catch error}
				<Card>
					<CardContent class="flex flex-col items-center justify-center py-12">
						...
						<p class="text-destructive mb-2">Failed to load entries</p>
